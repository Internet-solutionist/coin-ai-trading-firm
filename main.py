...
Runs the full 6-agent weekly cycle in paper mode.
"""
...
def run_paper_simulation(days: int = 30, show_dashboard: bool = True):
    ...
    console.print(f"Running {days}-day paper trading cycle with full 6-agent architecture\n")
    ...
    console.print(Panel.fit("[bold green]Simulation complete. All agents operated within constitutional limits.[/bold green]"))
...
if __name__ == "__main__":
    ...
    if args.mode == "paper":
        ...
        console.print("[red]Live mode requires broker API keys and real capital. Use --mode paper first.[/red]")